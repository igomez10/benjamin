...
// checks if the HistoryResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HistoryResult{}
...
func (o HistoryResult) ToMap() (map[string]interface{}, error) {
