...
// checks if the IserverContractConidInfoAndRulesGet200ResponseRulesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IserverContractConidInfoAndRulesGet200ResponseRulesInner{}

// IserverContractConidInfoAndRulesGet200ResponseRulesInner struct for IserverContractConidInfoAndRulesGet200ResponseRulesInner
type IserverContractConidInfoAndRulesGet200ResponseRulesInner struct {
...
func NewIserverContractConidInfoAndRulesGet200ResponseRulesInner() *IserverContractConidInfoAndRulesGet200ResponseRulesInner {
	this := IserverContractConidInfoAndRulesGet200ResponseRulesInner{}
	return &this
}
...
func (o IserverContractConidInfoAndRulesGet200ResponseRulesInner) MarshalJSON() ([]byte, error) {
...
func (o IserverContractConidInfoAndRulesGet200ResponseRulesInner) ToMap() (map[string]interface{}, error) {
...
type NullableIserverContractConidInfoAndRulesGet200ResponseRulesInner struct {
	value *IserverContractConidInfoAndRulesGet200ResponseRulesInner
	isSet bool
}

func (v NullableIserverContractConidInfoAndRulesGet200ResponseRulesInner) Get() *IserverContractConidInfoAndRulesGet200ResponseRulesInner {
	return v.value
}

func (v *NullableIserverContractConidInfoAndRulesGet200ResponseRulesInner) Set(val *IserverContractConidInfoAndRulesGet200ResponseRulesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableIserverContractConidInfoAndRulesGet200ResponseRulesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableIserverContractConidInfoAndRulesGet200ResponseRulesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIserverContractConidInfoAndRulesGet200ResponseRulesInner(val *IserverContractConidInfoAndRulesGet200ResponseRulesInner) *NullableIserverContractConidInfoAndRulesGet200ResponseRulesInner {
	return &NullableIserverContractConidInfoAndRulesGet200ResponseRulesInner{value: val, isSet: true}
}

func (v NullableIserverContractConidInfoAndRulesGet200ResponseRulesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIserverContractConidInfoAndRulesGet200ResponseRulesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
