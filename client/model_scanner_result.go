...
// checks if the ScannerResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScannerResult{}
...
func (o ScannerResult) ToMap() (map[string]interface{}, error) {
